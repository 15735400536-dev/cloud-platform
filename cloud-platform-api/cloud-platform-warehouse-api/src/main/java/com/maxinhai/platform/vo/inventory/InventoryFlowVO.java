...
public class InventoryFlowVO {
     ...
     */
    @ApiModelProperty("业务单号（如采购单号、销售单号，可空：如直接调整库存时）")
    private String orderCode;
    /**
     * 关联订单类型：1-采购入库单 2-销售出库单 3-调拨单 4-盘点单 5-报废单等
     */
    @ApiModelProperty("订单类型：1-采购入库单 2-销售出库单 3-调拨单 4-盘点单 5-报废单等")
     ...
     */
    @ApiModelProperty("操作类型：1-入库 2-出库 3-库存调整 4-调拨入库 5-调拨出库")
     ...
     * 操作时间（库存实际变动的时间）
     */
    @ApiModelProperty("操作时间（库存实际变动的时间）")
