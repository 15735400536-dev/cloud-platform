...
public class SimulateUserActionServiceImpl implements SimulateUserActionService {
    ...
    public void getLiveSteamingUser() {
        ...
        HttpRequest get = HttpUtil.createGet("https://www.douyin.com/webcast/web/feed/follow/?device_platform=webapp" + "&aid=6383" + "&channel=channel_pc_web" + "&scene=aweme_pc_follow_top" + "&update_version_code=170400" + "&pc_client_type=1" + "&pc_libra_divert=Windows" + "&support_h265=1" + "&support_dash=1" + "&cpu_core_num=20" + "&version_code=170400" + "&version_name=17.4.0" + "&cookie_enabled=true" + "&screen_width=1920" + "&screen_height=1080" + "&browser_language=zh-CN" + "&browser_platform=Win32" + "&browser_name=Chrome" + "&browser_version=136.0.0.0" + "&browser_online=true" + "&engine_name=Blink" + "&engine_version=136.0.0.0" + "&os_name=Windows" + "&os_version=10" + "&device_memory=8" + "&platform=PC" + "&downlink=10" + "&effective_type=4g" + "&round_trip_time=100" + "&webid=7507164795549173260&uifid=" + "&msToken=IRZNgqjWJoWnfBdbrn4BOUcoyjWVLcvrDzDHLCbqHUJAcsbvLrZRXTYKnjfVtijJfayMaONcxoBLzGrkInW8DNk95yhagQG3gLIA15lb8L0dftP_mIcT7GP9c8dt9q783G6InZl_C8x9cXy8gOBpp_y9QU0Uvvj0M64vX-QNRBJ4oQ%3D%3D&a_bogus=dj45g76yxdWROVMtmOD3yRZlOeEMrT8yEPixbwQTHOYBT1FaTmP32ae8coFzK5sVSuZzkI-7Tf4AiVpcOtUiZKFkwmkDSk7j5t%2FCnwvLMHkfT4Jg7ND2CbSEqiTbUSGY8%2FIvE%2F651s0e2E5W9NChApQ7K%2FUnm5jdFr3tV%2Fuji9K4UW8jwn%2Fna3YkLh17&verifyFp=verify_maz2to5l_WJRNPLUq_nzbE_4le3_91vq_QDjkUiNkgZa1&fp=verify_maz2to5l_WJRNPLUq_nzbE_4le3_91vq_QDjkUiNkgZa1");
